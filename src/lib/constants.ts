...
export const ICONS_MAP = new Map<string, string>([
  ...
  [Vehicles.NobleFirebrandMkXVII, "DestroyerTankFlameWIcon"],
  [Vehicles.FloodMkI, "BattleTankWar"],
  ...
  [Vehicles.DunneLandrunner12c, "TruckMobilityWarVehicleIcon"],
  ...
  [Vehicles.RinnspeirOrnitierClassGunship, "MediumBoatWVehicleIcon"],
  // Train Vehicles
