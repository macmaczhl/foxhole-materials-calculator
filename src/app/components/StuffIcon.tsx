...
const ICONS_MAP = new Map<string, string>([
  [
    ...
    "images/f/f0/ConstructionMaterialsIcon.png",
  ],
  [
    Materials.ProcessedConstructionMaterials,
    "images/f/fa/ProcessedConstructionMaterialsIcon.png",
  ],
  ...
  [
    ...
    "images/d/db/SteelConstructionMaterialsIcon.png",
  ],
  [Materials.ConcreteMaterials, "images/b/bd/ConcreteBagIcon.png"],
  [
    Materials.Pipe,
    "images/thumb/2/2a/EngineRoomPipeIcon.png/100px-EngineRoomPipeIcon.png",
  ],
  ...
  [
    Liquids.Petrol,
    "images/thumb/f/f1/RefinedFuelIcon.png/100px-RefinedFuelIcon.png",
  ],
  ...
  [
    RawResources.Components,
    "images/thumb/a/ac/ComponentsIcon.png/100px-ComponentsIcon.png",
  ],
  [RawResources.Coke, "images/d/d8/CokeIcon.png"],
  [
    RawResources.DamagedComponents,
    "images/thumb/b/bd/ComponentsDamagedIcon.png/100px-ComponentsDamagedIcon.png",
  ],
  [RawResources.Coal, "images/8/88/CoalIcon.png"],
  [
    RawResources.Sulfur,
    "images/thumb/b/be/SulfurIcon.png/100px-SulfurIcon.png",
  ],
  [RawResources.RareMetal, "images/e/ed/RareMaterialsIcon.png"],
  [
    RawResources.HeavyExplosivePowder,
    "images/thumb/2/21/HeavyExplosiveMaterialsIcon.png/100px-HeavyExplosiveMaterialsIcon.png",
  ],
